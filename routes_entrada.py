...
def nova_entrada():
    ...
    return render_template('entradas/form.html', itens=itens, fornecedores=fornecedores, numero_documento=numero_documento)
...
def lista_entradas():
    ...
    return render_template('entradas/list.html', entradas=entradas, filtro=filtro, busca=busca)
...
def visualizar_entrada(entrada_id):
    ...
    return render_template('entradas/detail.html', entrada=entrada)

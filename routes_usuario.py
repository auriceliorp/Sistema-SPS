...
def novo_usuario():
    ...
    if request.method == 'POST':
        ...
        if Usuario.query.filter_by(email=email).first():
            ...
            return render_template('usuarios/form.html', usuario=None, perfis=perfis, uls=uls)
...
def editar_usuario(id):
    ...
    return render_template('usuarios/form.html', usuario=usuario, perfis=perfis, uls=uls)

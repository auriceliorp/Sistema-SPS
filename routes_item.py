...
def detalhes_item(id):
    ...
    return render_template('itens/detail.html', item=item)
...
def novo_item():
    ...
    return render_template('itens/form.html', item=None, grupos=grupos, unidades=unidades)
...
def editar_item(id):
    ...
    grupos = Grupo.query.all()
    return render_template('itens/form.html', item=item, grupos=grupos, unidades=unidades)
